...
tar_plan(
	...
	tar_target(fig_06, qpdf::pdf_combine(factor_heatmaps_1q_combined, factor_heatmaps_2p_combined, factor_heatmaps_6p_combined, factor_heatmaps_16q_combined), "results/fig_06.pdf"),
	...
	tar_target(fig_04,
						 plot_fig_04_05(c("output/seurat/integrated_2p/seurat_2p_integrated_duo.rds", "output/seurat/SRR13884247_branch_6_filtered_seu.rds"), corresponding_clusters_enrichments[[6]], cluster_order = cluster_orders, large_clone_comparisons = large_clone_comparisons, scna_of_interest = "2p", width = 16, height = 12)
	),
	
	tar_target(fig_05,
						 plot_fig_04_05("output/seurat/integrated_6p/integrated_seu_6p_complete.rds", corresponding_clusters_enrichments[[7]], cluster_order = cluster_orders, large_clone_comparisons = large_clone_comparisons, scna_of_interest = "6p", width = 16, height = 12)
	),
	
	
	tar_target(integrated_seus_1q,
						 c(
						 	"SRR13884249_filtered_seu.rds" = "output/seurat/integrated_1q/SRR13884249_filtered_seu.rds", 
						 	"SRR14800534_filtered_seu.rds" = "output/seurat/integrated_1q/SRR14800534_filtered_seu.rds", 
						 	"SRR14800535_filtered_seu.rds" = "output/seurat/integrated_1q/SRR14800535_filtered_seu.rds", 
						 	"SRR14800536_filtered_seu.rds" = "output/seurat/integrated_1q/SRR14800536_filtered_seu.rds"
						 )
	),
	
	tar_target(integrated_seus_16q,
						 c(
						 	"SRR14800534_filtered_seu.rds" = "output/seurat/integrated_16q/SRR14800534_filtered_seu.rds",
						 	"SRR14800535_filtered_seu.rds" = "output/seurat/integrated_16q/SRR14800535_filtered_seu.rds",
						 	"SRR14800536_filtered_seu.rds" = "output/seurat/integrated_16q/SRR14800536_filtered_seu.rds"
						 )
	),
	
	tar_target(fig_07_input,
						 find_diffex_bw_clones_for_each_cluster(integrated_seus_1q, numbat_rds_files, large_clone_comparisons, cluster_dictionary, location = "all"),
						 pattern = map(integrated_seus_1q),
						 iteration = "list"
	),
	
	tar_target(fig_07,
						 plot_fig_07_08(fig_07_input, plot_path = "results/fig_07.pdf", height = 5, width = 4),
						 iteration = "list"
	),
	
	tar_target(fig_08_input,
						 find_diffex_bw_clones_for_each_cluster(integrated_seus_16q, numbat_rds_files, large_clone_comparisons, cluster_dictionary, location = "all"),
						 pattern = map(integrated_seus_16q),
						 iteration = "list"
	),
	
	tar_target(fig_08,
						 plot_fig_07_08(fig_08_input, plot_title = "fig_08", plot_path = "results/fig_08.pdf", height = 5, width = 6),
						 iteration = "list"
	),
	...
	tar_target(fig_09,
						 plot_fig_09_10(corresponding_seus_2p, corresponding_seus, corresponding_clusters_diffex, corresponding_clusters_enrichments, plot_path = "results/fig_09.pdf", widths = rep(4,3), heights = rep(6,3))
	),
	
	tar_target(
		corresponding_seus_6p,
		c(
			"SRR13884247_filtered_seu.rds" = "output/seurat/SRR13884247_filtered_seu.rds", 
			"SRR17960484_filtered_seu_6p.rds" = "output/seurat/SRR17960484_filtered_seu_6p.rds"
		)
	),
	
	tar_target(fig_10,
						 plot_fig_09_10(corresponding_seus_6p, corresponding_seus, corresponding_clusters_diffex, corresponding_clusters_enrichments, recurrence_threshold = 2, plot_path = "results/fig_10.pdf", widths = rep(4,3), heights = c(12, 4, 12))
	),
	...
	tar_target(corresponding_seus,
						 list(
						 	...
						 	"output/seurat/integrated_2p/seurat_2p_integrated_duo.rds",
						 	"output/seurat/integrated_6p/integrated_seu_6p_complete.rds"
						 )
	),
	...
	tar_target(corresponding_states_dictionary,
						 tibble::tribble(
						 	...
						 	"integrated_seu_6p_complete.rds",     "g1_6",      "g1_8", "6p"
						 )
	),
