...
tar_plan(
  ...
  # total metadata ------------------------------
  # figures_and_tables ordered targets and its denpendencies
  
  #~~ output fig_s02_table_s04
  ...
  #~~ output table_all_diffex_clones
  ...
  ##~~ output cluster_comparisons_by_phase_for_disctinct_clones
  tar_target(
      final_seus,
...
######################## END of figures_and_tables dependencies
