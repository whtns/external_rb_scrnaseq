...
vae.save("my_model_1q_or_6p_regressed/", overwrite = True)

vae = scvi.model.SCVI.load("my_model_1q_or_6p_regressed/", adata=adata_cond)
...
adata_cond.write_h5ad("output/scanpy/combined_adata_1q_or_6p_regressed.h5ad")

adata_cond = sc.read_h5ad("output/scanpy/combined_adata_1q_or_6p_regressed.h5ad")
