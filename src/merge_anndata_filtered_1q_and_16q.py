...
vae.save("my_model_1q_and_16q/", overwrite = True)

vae = scvi.model.SCVI.load("my_model_1q_and_16q/", adata=combined_adata)
...
combined_adata.write_h5ad("output/scanpy/combined_adata_filtered_1q_and_16q.h5ad")

# begin reanalysis ------------------------------

combined_adata = sc.read_h5ad("output/scanpy/combined_adata_filtered_1q_and_16q.h5ad")
sc.pp.log1p(combined_adata)
